...
<%
ResultSet find = (ResultSet) request.getSession().getAttribute("palabra_construccion");
%>
<!doctype html>
       ...
       <section class="section--center mdl-grid mdl-grid--no-spacing mdl-shadow--2dp">
            ...
            <div class="mdl-card mdl-cell mdl-cell--9-col-desktop mdl-cell--6-col-tablet mdl-cell--4-col-phone">
              <div class="mdl-card__supporting-text">
                  <h5>ID: <%= find.getString("ID") %></h5>
                  <strong>Nombre:<p><%= find.getString("Nombre") %></p></strong>
                  <strong>Descripcion:<p><%= find.getString("Descripcion") %></p> </strong>   
                  <strong>Precio:<p>$<%= find.getString("Precio") %></p> </strong>
                  <strong>Ubicación:<p><%= find.getString("Ubicacion") %></p> </strong>
                  <strong>Palabra Clave:<p><%= find.getString("Palabra_Clave") %></p> </strong>
                  <strong>ID Distribuidor:<p><%= find.getString("ID_distribuidor") %></p> </strong>
              </div>
